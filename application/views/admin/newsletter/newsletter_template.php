...
<!-- =============================== Body ====================================== -->
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0"  align="center" bgcolor='#620505'>
                ...
                <tr>
                  ...
                  <td align='left' valign='middle' >
                     <div class="contentEditableContainer contentTextEditable" style='display:inline-block;'>
                      <div class="contentEditable" >
                        <p style='color:#ffffff;font-size:13px;text-decoration:none;'>2018-03-23</p>
                      </div>
                    </div>
                  </td>
                  ...
                  <td align='right' valign='top' >
                    <div class="contentEditableContainer contentTextEditable" style='display:inline-block;'>
                      <div class="contentEditable" >
                        <a target='_blank' href="[SHOWEMAIL]" style='color:#fff;font-size:13px;'>Otwórz w przeglądarce</a>
                      </div>
                    </div>
                  </td>
  ...
  <tbody>
    <tr>
      <td valign="top"><div class="contentEditableContainer contentImageEditable">
                      <div class="contentEditable" >
                        <img src="https://sektor-it.pl/assets/emails/images/logoIt.png" alt='Compagnie logo' data-default="placeholder" data-max-width="350" width='350' height='80' border="0">
                      </div>
                    </div></td>
      <td valign="top" width="200" class="spechide">&nbsp;</td>
      <td valign="middle" width="200" align="right"><div class='contentEditableContainer contentTextEditable'>
  ...
  <tbody>
    <tr>
      <td valign="top" width="600"><div class="contentEditableContainer contentImageEditable">
                <div class="contentEditable" >
                  <img class="banner" src="https://sektor-it.pl/assets/emails/images/baner_newsletter.png" alt='Featured images' data-default="placeholder" data-max-width="800" width='800' height='200' border="0">
                </div>
              </div></td>
    </tr>
  </tbody>
  ...
  <tbody>
    <tr>
      <td valign="top" width="300" class="specbundle_img"><div class="contentEditableContainer contentImageEditable">
                        <div class="contentEditable" >
                          <img class="banner" src="https://sektor-it.pl/assets/emails/images/medImg.jpg" alt='product image' data-default="placeholder" data-max-width="300" width='300' height='240'>
                        </div>
                      </div></td>
      <td valign="top" bgcolor="#ffffff" class="specbundle"><table border="0" cellspacing="0" cellpadding="0"  align="center" width="100%">
                        <tr><td height='25' colspan='3'></td></tr>
                        <tr>
                          <td width='25'></td>
                          <td valign='top'>
                            <table border="0" cellspacing="0" cellpadding="0"  align="center">
                              ...
                              <tr>
                                <td align='left'>
                                  <div class="contentEditableContainer contentTextEditable">
                                    <div class="contentEditable" >
                                      <p >Do you have a health tip, meditation tip or exercise of the week to share? Give a hint about it</p>
                                    </div>
                                  </div>
                                </td>
                              </tr>
                              ...
                              <tr>
                                <td align='left'>
                                  <div class="contentEditableContainer contentTextEditable">
                                    <div class="contentEditable" >
                                      <a target='_blank' href='#' class='link2' style='background: #E3A552;color:#ffffff;'>Link to your website</a>
                                    </div>
                                  </div>
                                </td>
                              </tr>
  ...
  <tbody>
    <tr>
      <td valign="top" bgcolor="#ffffff" class="specbundle_img"><table border="0" cellspacing="0" cellpadding="0"  align="center" width="100%">
                        <tr><td height='25' colspan='3'></td></tr>
                        <tr>
                          <td width='25'></td>
                          <td valign='top'>
                            <table border="0" cellspacing="0" cellpadding="0"  align="center">
                              ...
                              <tr>
                                <td align='left'>
                                  <div class="contentEditableContainer contentTextEditable">
                                    <div class="contentEditable" >
                                      <p style='font-size:13px;line-height:19px;font-weight:normal;'>Do you have a health tip, meditation tip or exercise of the week to share? Give a hint about it</p>
                                    </div>
                                  </div>
                                </td>
                              </tr>
      ...
      <td valign="top" width="300" class="specbundle_img"><div class="contentEditableContainer contentImageEditable">
                        <div class="contentEditable" >
                          <img class="banner" src="https://sektor-it.pl/assets/emails/images/medImg.jpg" alt='product image' data-default="placeholder" data-max-width="305" width='305' height='240'>
                        </div>
                      </div></td>
    </tr>
  </tbody>
      ...
      <div class="movableContent" style="border: 0px; padding-top: 0px; position: relative;">
      <table border="0" cellspacing="0" cellpadding="0"  align="center" width="100%" bgcolor='#C3CAA9'>
                        <tr><td height='25' colspan='3'></td></tr>
                        <tr>
                          <td width='25'></td>
                          <td>
                            <table border="0" cellspacing="0" cellpadding="0"  align="center">
                              <tr>
                                <td>
                                  <table border="0" cellspacing="0" cellpadding="0"  align="center" width="100%">
                                    <tr>
                                      <td width='175'><div style='border:1px solid #A9B288;'></div></td>
                                      <td width='200' style='padding:0 10px;'>
                                        <div class="contentEditableContainer contentTextEditable">
                                          <div class="contentEditable" style='color:#585C49;font-size:26px;font-weight:normal;font-family:georgia;text-align:center;'>
                                            <h1 class='bigger'>Frequently Asked question</h1>
                                          </div>
                                        </div>
                                      </td>
                                      <td width='175'><div style='border:1px solid #A9B288;'></div></td>
                              ...
                              <tr>
                                <td>
                                  <div class="contentEditableContainer contentTextEditable">
                                    <div class="contentEditable" >
                                      <p style='color:#7E8564;font-size:13px;line-height:19px;font-weight:normal;text-align:center;'>This is a great spot to answer a question that people ask often. You can also use this space to offer a promotion or seasonal special. It’s visually different, so keep it for an important message.</p>
                                    </div>
                                  </div>
                                </td>
                              </tr>
                                ...
                                <td>
                                  <div class="contentEditableContainer contentTextEditable">
                                    <div class="contentEditable" align='center'>
                                      <a target='_blank' href='#' style='padding:10px 20px;border-radius:3px;-moz-border-radius:3px;-webkit-border-radius:3px;color:#ffffff;font-size:13px;background:#7E8564;text-decoration:none;'>Call to action</a>
                                    </div>
                                  </div>
                                </td>
                              </tr>
  ...
  <tbody>
    <tr>
      ...
      <td><table border="0" cellspacing="0" cellpadding="0"  align="center" width="100%">
                              ...
                              <tr>
                                <td align='left' width='330'>
                                  <div class="contentEditableContainer contentTextEditable">
                                    <div class="contentEditable" >
                                      <p >You can provide a short description of a blog post you wrote recently.</p>
                                    </div>
                                  </div>
                                </td>
                              </tr>
                              ...
                              <tr>
                                <td align='left'>
                                  <div class="contentEditableContainer contentTextEditable">
                                    <div class="contentEditable" >
                                      <a target='_blank' href='#' class='link1'>Call to action</a>
                                    </div>
                                  </div>
                                </td>
                              </tr>
      ...
      <td valign="top" width="95" class="specbundle_img">&nbsp;</td>
      <td valign="middle" width="125" class="specbundle_img"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tbody>
    <tr>
      <td valign="middle" align="center"><div class="contentEditableContainer contentImageEditable">
                              <div class="contentEditable" >
                                <img src="https://sektor-it.pl/assets/emails/images/blogImg.png" alt='Blog image' data-default="placeholder" data-max-width="100" width='100' height='100'>
                              </div>
                            </div></td>
      <td valign="top" width="25" class="spechide">&nbsp;</td>
    </tr>
  </tbody>
</table>
</td>
      ...
      <td><table border="0" cellspacing="0" cellpadding="0"  align="center" width="100%">
                              ...
                              <tr>
                                <td align='left' width='330'>
                                  <div class="contentEditableContainer contentTextEditable">
                                    <div class="contentEditable" >
                                      <p >Talk about the instructor, where they were trained, what they believe in. Keep it personal so people get a sense of who will be guiding them to a more healthful lifestyle.</p>
                                    </div>
                                  </div>
                                </td>
                              </tr>
      ...
      <td valign="top" align="left" class="specbundle2"><div class="contentEditableContainer contentTextEditable">
                            <div class="contentEditable" align='center'>
                              <p  style='text-align:left;color:#999999;font-size:12px;font-weight:normal;line-height:20px;'>
                                ...
                                [CLIENTS.ADDRESS]
                                <br>
                                <a target='_blank' href="[FORWARD]" style='font-size:13px; color:#999999;'>Forward to a friend</a>
                              </p>
                            </div>
                          </div></td>
  ...
  <tbody>
    <tr>
      <td width="52" height="54" valign="top" align="center"><div class="contentEditableContainer contentFacebookEditable">
                            <div class="contentEditable">
                              <a target='_blank' href="#"><img src="https://sektor-it.pl/assets/emails/images/facebook2.png" width='52' data-customIcon="true" height='52' alt='facebook icon' data-default="placeholder" data-max-width="52"></a>
                            </div>
                          </div></td>
      ...
      <td valign="top" width="52" align="center"><div class="contentEditableContainer contentTwitterEditable">
                            <div class="contentEditable">
                              <a target='_blank' href="#"><img src="https://sektor-it.pl/assets/emails/images/twitter2.png" width='52' data-customIcon="true" height='52' alt='twitter icon' data-default="placeholder" data-max-width="52"></a>
                            </div>
                          </div></td>
    </tr>
  </tbody>
      ...
      <div class="customZone" data-type="imageText">
          <div class='movableContent'>
                <table width="600" border="0" cellspacing="0" cellpadding="0"  align="center">
                  ...
                  <tr>
                    <td width='300' valign='top' class='bgItem'>
                      <div class="contentEditableContainer contentImageEditable">
                        <div class="contentEditable" >
                          <img src="https://sektor-it.pl/assets/emails/images/medImg.jpg" alt='product image' data-default="placeholder" data-max-width="300" width='300' height='240'>
                        </div>
                      </div>
                    </td>
                    <td width='300' valign='top' class='bgItem'>
                ...
                <table width="600" border="0" cellspacing="0" cellpadding="0"  align="center">
                  ...
                  <tr>
                    ...
                    <td width='300' valign='top' class='bgItem'>
                      <div class="contentEditableContainer contentImageEditable">
                        <div class="contentEditable" >
                          <img src="https://sektor-it.pl/assets/emails/images/medImg.jpg" alt='product image' data-default="placeholder" data-max-width="305" width='305' height='240'>
                        </div>
                      </div>
                    </td>
                  </tr>
      ...
      <div class="customZone" data-type="textText">
          <div class='movableContent'>
                <table width="600" border="0" cellspacing="0" cellpadding="0"  align="center">
                  ...
                  <tr>
                    <td class='bgItem' width='295' valign='top'>
                      <table border="0" cellspacing="0" cellpadding="0"  align="center">
                        <tr><td height='25' colspan='3'></td></tr>
                          ...
                          <td valign='top' valign="top" style="padding:0 20px 0 20px;">
                              <div class="contentTextEditable contentEditableContainer">
                                  <div class="contentEditable">
                                      ...
                                      <p style='text-align:right;margin:0;font-family:Georgia, serif;'><a target='_blank' style='color:#7E8564;font-size:13px;font-weight:bold;text-decoration:none;'>Read more →</a></p>
                          ...
                          <td valign='top' style="padding:0 20px 0 20px;">
                              <div class="contentEditableContainer contentTextEditable">
                                  <div class="contentEditable">
                                      ...
                                      <p >Etiam bibendum nunc in lacus bibendum porta. Vestibulum nec nulla et eros ornare condimentum. Proin facilisis, dui in mollis blandit. Sed non dui magna, quis tincidunt enim. Morbi vehicula pharetra lacinia. Cras tincidunt, justo at fermentum feugiat, eros orci accumsan dolor, eu ultricies eros dolor quis sapien.</p>
                                      <p >Integer in elit in tortor posuere molestie non a velit. Pellentesque consectetur, nisi a euismod scelerisque.</p>
                                      <p style='text-align:right;margin:0;'><a target='_blank' href="#" style='color:#7E8564;font-size:13px;font-weight:bold;text-decoration:none;'>Read more →</a></p>

...
<div class="col-lg-4 col-md-4 col-md-offset-4 pa-login">
  <div class="panel panel-success">
    ...
    <div class="panel-body" style="text-align:center;">
      Pomyślnie się zalogowałeś!<br><br>
      Za chwilę nastąpi przekierowanie do Panelu Administracyjnego.<br>
      <a href=<?php echo site_url('/admin/posts/newest/'); ?>>Naciśnij tutaj, jeśli przeglądarka Cię nie przekierowała</a>.
      <?php
        header('Refresh: 2; url='.site_url('/admin/posts/newest/'));
      ?>        
    </div>
